...
class UserServiceImplTest {
    ...
    class createUser{
        @Test
        @DisplayName("createUser() creates a new User successfully returning UserResponse with the user's data and generated UUID id")
    ...
    class getUserById{
        ...
        void shouldThrowUserNotFoundException_whenUserDoNotExistInDbWithMatchingId() {
    ...
    class getUserByName{
        @Test
        @DisplayName("getUserByName() returns a List<UserResponse> instance with users data when users with the name passed as parameter exist in db")
